...
SECRET_KEY = 'ba9lz)zu-$$_dxc#z*f^spq+56ybnws1dutik*6!47d=gj6-p#'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['tomgrandson.usermd.net','127.0.0.1', 'localhost']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                'crm.context_processors.display_notofications',
